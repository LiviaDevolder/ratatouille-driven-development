# 🐀 RDD Agents — Claude Code

> Subagentes + Skills para [Claude Code](https://docs.anthropic.com/en/docs/claude-code/overview) que transformam requisitos vagos em histórias de usuário e planos de desenvolvimento.
>
...
Dois agentes especializados para o Claude Code que automatizam as etapas que a maioria dos devs pula por falta de tempo:
...
# Copiar subagentes
cp -r ratatouille-driven-development/claude-code/.claude SEU-PROJETO/

# Copiar skills e referências
cp -r ratatouille-driven-development/claude-code/skills SEU-PROJETO/

# Copiar diretórios de saída
cp -r ratatouille-driven-development/claude-code/docs SEU-PROJETO/

# Adicionar conteúdo do CLAUDE.md ao seu projeto
cat ratatouille-driven-development/claude-code/CLAUDE.md >> SEU-PROJETO/CLAUDE.md
```
...
cp ratatouille-driven-development/claude-code/.claude/agents/*.md ~/.claude/agents/
```
...
Edite os arquivos em `skills/*/references/` para adaptar os templates ao padrão da sua empresa.
